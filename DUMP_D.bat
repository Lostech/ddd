::********************************************************************
:: Dump Skript zur Erzeugung eines Festplatten Images auf Laufwerk D:
::********************************************************************
@echo off

:: Altes Image löschen
echo.
if exist D:/PVRIMAGE.bin echo Loesche altes Image
if exist D:/PVRIMAGE.bin echo .
if exist D:/PVRIMAGE.bin del D:/PVRIMAGE.bin

:: Neues Image erzeugen
echo Erzeuge Image "D:/PVRIMAGE.bin"
ddd.exe D:/PVRIMAGE.bin
