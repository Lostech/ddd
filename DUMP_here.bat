::********************************************************************
:: Dump Skript zur Erzeugung eines Festplatten Images auf Laufwerk F:
::********************************************************************
@echo off

:: Altes Image löschen
echo.
if exist D:/Lostech/ddd/PVRIMAGE.bin echo Loesche altes Image
if exist D:/Lostech/ddd/PVRIMAGE.bin echo .
if exist D:/Lostech/ddd/PVRIMAGE.bin del D:/Lostech/ddd/PVRIMAGE.bin

:: Neues Image erzeugen
echo Erzeuge Image "D:/Lostech/ddd/PVRIMAGE.bin"
ddd.exe D:/Lostech/ddd/PVRIMAGE.bin
