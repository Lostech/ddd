...
:: Altes Image löschen
echo.
if exist F:/PVRIMAGE.bin echo Loesche altes Image
if exist F:/PVRIMAGE.bin echo .
if exist F:/PVRIMAGE.bin del F:/PVRIMAGE.bin

:: Neues Image erzeugen
echo Erzeuge Image "F:/PVRIMAGE.bin"
ddd.exe F:/PVRIMAGE.bin
