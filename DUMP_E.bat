::********************************************************************
:: Dump Skript zur Erzeugung eines Festplatten Images auf Laufwerk E:
::********************************************************************
@echo off

:: Altes Image löschen
echo.
if exist E:/PVRIMAGE.bin echo Loesche altes Image
if exist E:/PVRIMAGE.bin echo .
if exist E:/PVRIMAGE.bin del E:/PVRIMAGE.bin

:: Neues Image erzeugen
echo Erzeuge Image "E:/PVRIMAGE.bin"
ddd.exe E:/PVRIMAGE.bin
